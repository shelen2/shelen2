                            ...
                            if ($query->num_rows() > 0) {
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    <div class="serv" >
                                        <div class="box">
                                            <div class="box-image">
                                                <a href="<?php echo base_url(); ?>imagesService/<?php echo $row->photo_name; ?>"  data-pretty="prettyPhoto" title="تفاصيل الخدمه" class="thumb">
                                                <img src="<?php echo base_url(); ?>imagesService/thumb/<?php echo $row->photo_name; ?>"  width="200" height="200" alt="" /></a>
                                            </div>
