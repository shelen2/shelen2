            ...
            <div class="content left">
                <div class="wrapper">
                    ...
                    <div class="left-page left">
						...
						<a href="<?php echo base_url(); ?>user/user_chat"><img id="mail_icon" src="<?php echo base_url();?>images/mail.png" />	</a>
                        <p id="sender">رساله من </p>
                        <p id="sender" style="padding:0 5px 0 5px;color:#3C6"><a style="color:#3C6" id="user" href="#">mohamed temraz</a></p>
                        <p id="sender"><a href="<?php echo base_url(); ?>user/user_chat">واكيد فيه جيل اوصافه غير نفس الاوصاف</a></p>
